> **DEPRECATED** — Content subsumed into `system/state_machine/AIM_state_machine_v3.md`
> Sections 11 (Ontology), 12 (Prakriyā Execution Engine), 13 (Adhikāra Modeling),
> and 14 (System Integrity Constraints). Architecture updated from two-layer to
> three-layer; Stage 0 behavior added. Do not use this file for implementation.

# Advaita Inquiry Matrix

<img src="artwork/AIṀ.png" alt="AIṀ" style="zoom:10%;" />
