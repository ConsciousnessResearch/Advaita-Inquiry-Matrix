...
adhyaya: 1
valli: 3
text_role: misidentification-exposure-and-contextual-integration
macro_prakriyā: instrument-analysis → progressive-disidentification → apophatic-termination → participatory-stabilization
interaction_mode: structural-discrimination
advaita_bhakti_dynamic: performative-transition
epistemic_model: recognition-independent-of-instrument
ontology_model: non-diminishing-fullness (implicit)
doubt_resolution: subject-instrument-separation
karma_status: binding-when-self-is-taken-as-instrument
immortality_model: irreversible-contextual-clarity
macro_arc: chariot-structure → hierarchy-exhaustion → sacred-integration
dependencies: [1.2 epistemic-deconstruction]
teaching_device: chariot-analogy
teaching_stage: instrument disidentification
```
...
```yaml
tags: [interiority, dual-experience, sacred-threshold]
prakriyā: contextual-reorientation
pedagogical_role: interiorization-of-experience
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: contemplative-reflection
dependencies: [1.2]
...
Know the Ātman as the lord of the chariot, the body as only the chariot, know also intelligence as the driver; know the mind as the reins.

---


```yaml
tags: [chariot-metaphor, instrument-mapping]
prakriyā: structural-instrument-analysis
pedagogical_role: identity-dislocation
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: analytical-discrimination
dependencies: [1-2]
...
The senses, they say, are the horses; the objects which they perceive, the way; the Ātman, the senses and the mind combined, the intelligent call the enjoyer.
...
```yaml
tags: [mind-control, discrimination, instrument-mastery]
prakriyā: misidentification-exposure
pedagogical_role: instrument-limitation-clarification
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: discriminative-evaluation
dependencies: [3-4]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
Beyond the senses, are the rudiments of its objects; beyond these rudiments is the mind; beyond the mind is Ātman known as Māhāt (great).

---


```yaml
tags: [gradation, subtlety-sequence]
prakriyā: progressive-disidentification
pedagogical_role: scope-expansion
...
```yaml
tags: [apophatic-termination, puruṣa]
prakriyā: hierarchy-exhaustion
pedagogical_role: structural-stabilization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
```yaml
tags: [subtle-seeing, inward-withdrawal]
prakriyā: contextual-refinement
pedagogical_role: subtle-attention-training
adhikāra_level: uttama
pedagogical_stage: manana
cognitive_mode: contemplative-internalization
dependencies: [10-11]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
Let the intelligent man sink speech into mind, sink that into intelligence and intelligence into the great ātman, and sink that into the peaceful ātman.
...
```yaml
tags: [urgency, vigilance]
prakriyā: existential-intensification
pedagogical_role: destabilization-of-complacency
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: alert-attentiveness
dependencies: [12-13]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
```yaml
tags: [apophatic-description, non-objectifiability]
prakriyā: apophatic-clarification
pedagogical_role: object-negation
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
```yaml
tags: [transmission, sacred-recitation, contextual-stabilization]
prakriyā: participatory-integration
pedagogical_role: embodied-context-preservation
adhikāra_level: universal
pedagogical_stage: nididhyāsana
cognitive_mode: devotional-confidence
...
Whoever with zeal, causes to be recited before an assembly of brāhmaṇas or at the time of śraddhā of the ancestors, this highest secret, that secures immortality, secures immortality.
