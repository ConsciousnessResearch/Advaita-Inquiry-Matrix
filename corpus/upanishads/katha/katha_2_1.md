...
adhyaya: 2
valli: 1
text_role: ontological-consolidation-and-nonduality-clarification
macro_prakriyā: outward-diagnosis → inward-reversal → recognition-formula → nondual-assertion → difference-negation
interaction_mode: contemplative-ontological-clarification
advaita_bhakti_dynamic: nondual-recognition-with-symbolic-language
epistemic_model: recognition-confirmed-through-structural-vision
ontology_model: non-differentiable-self-presence
doubt_resolution: negation-of-perceived-difference
karma_status: death-through-difference-vision
immortality_model: nondual-identity-across-here-and-there
macro_arc: sensory-extraversion → inward-seeing → etad-vai-tat-refrain → non-difference-assertion → identity-stabilization
recognition_device: etad-vai-tat
teaching_stage: witness recognition
```
...
The self-existent created the senses out-going: therefore, one sees outside and not the Ātman within. Some intelligent man, with his senses turned away, (from their object), desirous of immortality, sees the Ātman within.

---


```yaml
tags: [sensory-extraversion, inward-reversal, immortality-seeking]
prakriyā: contextual-diagnosis-and-reversal
pedagogical_role: attention-redirection
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: contemplative-introspection
dependencies: [1.3 stabilization]
...
```yaml
tags: [desire-pursuit, death-bondage, dhīra-contrast]
prakriyā: existential-contrast-clarification
pedagogical_role: miscontextualization-exposure
adhikāra_level: madhyama
pedagogical_stage: manana
...
```yaml
tags: [witness-consciousness, waking-dream-unity, etad-vai-tat]
prakriyā: recognition-confirmation
pedagogical_role: experiential-unification
...
```yaml
tags: [cosmic-identity, heart-cavity, agni-symbolism, etad-vai-tat]
prakriyā: symbolic-universalization
pedagogical_role: context-expansion
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
The fire lodged in the araṇis, as the foetus is well-borne by the pregnant woman fit to be worshipped every day by watchful offerers and other men. This verily is That.
...
```yaml
tags: [here-there-identity, nonduality, death-through-difference]
prakriyā: nondual-assertion
pedagogical_role: difference-negation
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
```yaml
tags: [no-difference, mind-as-instrument, death-through-division]
prakriyā: difference-negation
pedagogical_role: ontological-stabilization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
```yaml
tags: [inner-puruṣa, light-without-smoke, identity-imagery]
prakriyā: symbolic-interiorization
pedagogical_role: contemplative-focus
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
As rainwater, (falling) on the mountain top, runs down over the rocks on all sides; similarly, he who sees difference (between visible forms) runs after them in various directions.

---


```yaml
tags: [difference-perception, dispersion-analogy]
prakriyā: miscontextualization-warning
pedagogical_role: instability-exposure
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: reflective-analogy
dependencies: [10-13]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
As water pure poured into pure becomes the same only, so the Ātman of the thinker who knows thus, becomes; Oh *Gautama*.

---

```yaml
tags: [purity-analogy, identity-unification]
prakriyā: assimilation-illustration
pedagogical_role: identity-stabilization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: contemplative-integration
dependencies: [14]
