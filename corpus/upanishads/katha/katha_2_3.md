...
adhyaya: 2
valli: 3
text_role: final-culmination-and-liberation-clarification
macro_prakriyā: cosmic-metaphor → fear-of-brahman → urgency-of-recognition → hierarchy-reprise → non-objectifiability → yoga-definition → desire-dissolution → heart-knot-cutting → transmission-closure
interaction_mode: ontological-culmination-and-instructional-finalization
advaita_bhakti_dynamic: nondual-assertion-with-symbolic-intensity
epistemic_model: recognition-stabilized-through-negation-and-integration
ontology_model: self-luminosity-and-non-objectifiability
doubt_resolution: total-misidentification-collapse
karma_status: knot-severance-and-rebirth-termination
immortality_model: immediate-brahman-attainment-here
macro_arc: inverted-tree → existential-fear → recognition-urgency → puruṣa-culmination → yoga-stillness → desire-collapse → heart-knot-severance → transmission-completion
teaching_stage: liberation stabilization
```
...
```yaml
tags: [inverted-tree, brahman-root, cosmic-dependence, etad-vai-tat]
prakriyā: cosmic-metaphor-expansion
pedagogical_role: ontological-foundation-assertion
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: symbolic-integration
dependencies: [2.1–2.2 consolidation]
...
```yaml
tags: [cosmic-fear, prāṇa-dynamism, immortality-through-knowledge]
prakriyā: existential-intensification
pedagogical_role: metaphysical-seriousness
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: ontological-contemplation
dependencies: [1]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [fear-of-brahman, cosmic-order]
prakriyā: sovereignty-assertion
pedagogical_role: divine-dependence-clarification
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: metaphysical-integration
dependencies: [2]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [immediacy-of-recognition, embodiment-warning]
prakriyā: existential-urgency
pedagogical_role: procrastination-negation
adhikāra_level: madhyama
pedagogical_stage: nididhyāsana
cognitive_mode: existential-alertness
dependencies: [2-3]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [mirror-analogy, dream-analogy, loka-gradation]
prakriyā: clarity-gradation
pedagogical_role: recognition-differentiation
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: analogical-refinement
dependencies: [4]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [indriya-separation, dhīra-non-grief]
prakriyā: instrument-disidentification
pedagogical_role: sorrow-transcendence
adhikāra_level: madhyama
pedagogical_stage: nididhyāsana
cognitive_mode: structural-discrimination
dependencies: [1.3 reprise]
...
```yaml
tags: [indriya-manas-buddhi-mahat-sequence]
prakriyā: progressive-disidentification-reprise
pedagogical_role: structural-reaffirmation
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: hierarchical-negation
dependencies: [6]
...
```yaml
tags: [avyakta-beyond, puruṣa-culmination]
prakriyā: hierarchy-termination
pedagogical_role: final-identity-assertion
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: apophatic-escalation
dependencies: [7]
...
```yaml
tags: [non-objectifiable-self, mind-negation]
prakriyā: epistemic-negation
pedagogical_role: perception-limitation-clarification
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: negation-analysis
dependencies: [8]
ontological_scope: pāramārthika
relational_mode: non-differentiable
```
...
```yaml
tags: [sense-withdrawal, stillness, paramā-gati]
prakriyā: meditative-definition
pedagogical_role: experiential-stabilization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: contemplative-absorption
dependencies: [9]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [yoga-definition, vigilance]
prakriyā: stabilization-warning
pedagogical_role: practice-clarification
adhikāra_level: madhyama
pedagogical_stage: integration
cognitive_mode: disciplined-awareness
dependencies: [10]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
```yaml
tags: [speech-negation, mind-negation, astīti]
prakriyā: epistemic-limitation
pedagogical_role: affirmation-gateway
adhikāra_level: uttama
pedagogical_stage: manana
cognitive_mode: reflective-affirmation
dependencies: [9]
ontological_scope: pāramārthika
relational_mode: non-differentiable
```
...
```yaml
tags: [existence-affirmation, tattva-revelation]
prakriyā: affirmation-stabilization
pedagogical_role: recognition-confirmation
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: contemplative-recognition
dependencies: [12]
ontological_scope: pāramārthika
relational_mode: non-differentiable
```
...
```yaml
tags: [desire-dissolution, heart-purification]
prakriyā: vāsanā-collapse
pedagogical_role: immortality-realization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: existential-release
dependencies: [13]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [heart-knots, final-instruction]
prakriyā: bondage-severance
pedagogical_role: liberation-definition
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: ontological-clarification
dependencies: [14]
ontological_scope: pāramārthika
relational_mode: non-differentiable
```
...
```yaml
tags: [nāḍī-symbolism, upward-path, immortality-route]
prakriyā: symbolic-departure-clarification
pedagogical_role: post-mortem-contextualization
adhikāra_level: madhyama
pedagogical_stage: integration
cognitive_mode: metaphysical-symbolism
dependencies: [15]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
```yaml
tags: [inner-puruṣa, extraction-metaphor, purity]
prakriyā: interiorization-intensification
pedagogical_role: contemplative-extraction
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: symbolic-recognition
dependencies: [8, 15]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [transmission-completion, brahma-attainment, exemplar]
prakriyā: narrative-closure
pedagogical_role: model-realization
adhikāra_level: universal
pedagogical_stage: integration
cognitive_mode: inspirational-confirmation
...
Let Him protect us both; let us exert together may what we study be well studied; may we not hate. Om! Peace! Peace! Peace!

---


```yaml
tags: [guru-śiṣya-unity, study-protection, peace-invocation]
prakriyā: transmission-sealing
pedagogical_role: relational-harmony
adhikāra_level: universal
pedagogical_stage: integration
cognitive_mode: devotional-integration
dependencies: [entire-text]
ontological_scope: dual-register
