...
adhyaya: 2
valli: 2
text_role: ontological-deepening-and-identity-clarification
macro_prakriyā: body-symbolism → prāṇa-relativization → rebirth-mechanism → witness-assertion → non-attachment-clarification → light-of-lights-culmination
interaction_mode: contemplative-metaphysical-clarification
advaita_bhakti_dynamic: nondual-recognition-through-symbolic-expansion
epistemic_model: recognition-stabilized-through-universalization
ontology_model: non-objectifiable-self-luminosity
doubt_resolution: dehātma-bhrama-negation
karma_status: embodiment-and-rebirth-contextualized
immortality_model: self-luminosity-independent-of-prāṇa
macro_arc: body-as-city → prāṇa-subordination → rebirth-logic → inner-witness → universal-metaphors → light-of-lights
teaching_stage: universalization
```
...
```yaml
tags: [body-as-city, interiorization, ajasya]
prakriyā: symbolic-interiorization
pedagogical_role: dehātma-bhrama-weakening
adhikāra_level: madhyama
pedagogical_stage: nididhyāsana
cognitive_mode: contemplative-symbolism
dependencies: [2.1 stabilization]
...
```yaml
tags: [cosmic-pervasion, ham̐sa-symbolism, universality]
prakriyā: universalization-of-self
pedagogical_role: contextual-expansion
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: contemplative-integration
dependencies: [1]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [prāṇa-relativization, inner-presence, worship]
prakriyā: prāṇa-subordination
pedagogical_role: life-force-decentralization
adhikāra_level: madhyama
...
```yaml
tags: [body-departure, dehātma-bhrama-negation, etad-vai-tat]
prakriyā: identity-separation
pedagogical_role: mortality-reframing
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: existential-inquiry
dependencies: [3]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [prāṇa-dependence, life-source, instrument-relativization]
prakriyā: instrument-negation
pedagogical_role: causal-reorientation
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
```yaml
tags: [secret-brahman, post-mortem-clarification]
prakriyā: doctrinal-explication
pedagogical_role: karmic-framework-clarification
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: metaphysical-instruction
dependencies: [5]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
```yaml
tags: [rebirth-mechanism, karma, knowledge-conditioning]
prakriyā: karmic-differentiation
pedagogical_role: moral-cosmology-contextualization
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: causal-analysis
dependencies: [6]
ontological_scope: vyavahārika
relational_mode: performative-transition
```
...
```yaml
tags: [witness-consciousness, dream-creation, etad-vai-tat]
prakriyā: experiential-universalization
pedagogical_role: state-recontextualization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
...
```yaml
tags: [metaphor-of-fire, metaphor-of-wind, form-assumption]
prakriyā: metaphorical-universalization
pedagogical_role: multiplicity-without-division
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: analogical-integration
dependencies: [8]
ontological_scope: dual-register
relational_mode: performative-transition
```
...
```yaml
tags: [sun-metaphor, non-attachment, world-suffering]
prakriyā: non-adhesion-clarification
pedagogical_role: duḥkha-recontextualization
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: ontological-clarification
dependencies: [9-10]
...
```yaml
tags: [one-controller, multiplicity-within-unity]
prakriyā: unity-within-diversity-clarification
pedagogical_role: bliss-distinction
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: contemplative-recognition
dependencies: [9-11]
...
```yaml
tags: [eternal-among-ephemeral, peace-distinction]
prakriyā: ontological-contrast
pedagogical_role: permanence-clarification
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: ontological-clarification
dependencies: [12]
...
```yaml
tags: [anirdeśya, supreme-bliss, epistemic-humility]
prakriyā: apophatic-humility
pedagogical_role: language-limitation-exposure
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: reflective-inquiry
dependencies: [12-13]
ontological_scope: pāramārthika
relational_mode: non-differentiable
```
...
```yaml
tags: [self-luminosity, light-of-lights, non-dependent-illumination]
prakriyā: luminosity-assertion
pedagogical_role: ultimate-clarification
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: apophatic-affirmation
dependencies: [entire-chapter]
ontological_scope: pāramārthika
relational_mode: non-differentiable
```
