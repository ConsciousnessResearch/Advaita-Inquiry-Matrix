...
prakriyā: ritual-frame-invocation
ontological_scope: vyavahārika
pedagogical_role: auspicious-opening-within-apara-domain
...
sa brahmavidyāṃ sarvavidyāpratiṣṭhāmatharvāya
...
```yaml
cluster: transmission_authority
prakriyā: paramparā-establishment
ontological_scope: vyavahārika
pedagogical_role: epistemic-legitimation
...
```yaml
cluster: transmission_authority
prakriyā: paramparā-continuity
ontological_scope: vyavahārika
pedagogical_role: lineage-reinforcement
knowledge_tier: transitional
adhikāra_level: madhyama
pedagogical_stage: śravaṇa
```
...
```yaml
cluster: knowledge_unification
prakriyā: epistemic-compression-inquiry
ontological_scope: scope-clarification
pedagogical_role: entry-into-para-discourse
knowledge_tier: transitional
...
prakriyā: para-apara-differentiation
ontological_scope: scope-clarification
pedagogical_role: hierarchy-explication
knowledge_tier: bifurcation
adhikāra_level: madhyama
pedagogical_stage: śravaṇa
```
...
Of these two, the lower knowledge is the Ṛg-Veda, the Yajur-Veda, the Sāma-Veda, the Atharva-Veda, siksha (phonetics), kalpa (rituals), vyakaranam (grammar), nirukta (etymology), chhandas (metre) and jyotis (astronomy); and the Higher Knowledge is that by which the Imperishable Brahman is attained.
...
```yaml
cluster: knowledge_transition
prakriyā: explicit-apara-listing
ontological_scope: vyavahārika
pedagogical_role: preparatory-domain-definition
knowledge_tier: apara_vidyā
adhikāra_level: madhyama
pedagogical_stage: śravaṇa
```
...
prakriyā: akṣara-definition
ontological_scope: dual-register
pedagogical_role: object-of-para-vidyā-description
...
```yaml
cluster: emanation_cosmology
prakriyā: source-universe-derivation
ontological_scope: dual-register
pedagogical_role: dependence-clarification
knowledge_tier: para_vidyā
adhikāra_level: madhyama-to-uttama
pedagogical_stage: manana
```
...
```yaml
cluster: emanation_cosmology
prakriyā: cosmic-expansion-sequence
ontological_scope: dual-register
pedagogical_role: manifestation-structure-mapping
knowledge_tier: para_vidyā
adhikāra_level: madhyama-to-uttama
pedagogical_stage: manana
```
...
```yaml
cluster: emanation_cosmology
prakriyā: universe-return-implication
ontological_scope: dual-register
pedagogical_role: ontological-dependence-closure
knowledge_tier: para_vidyā
adhikāra_level: madhyama-to-uttama
pedagogical_stage: manana
```
