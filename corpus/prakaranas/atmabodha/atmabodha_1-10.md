...
I am composing Ātmabodha, this treatise of the Knowledge of the Self, for those who have purified themselves by austerities and are peaceful in heart and calm, who are free from cravings and are desirous of liberation.

---


```yaml
cluster: adhikāra_definition
prakriyā: eligibility-establishment
ontological_scope: scope-clarification
pedagogical_role: audience-boundary-clarification
adhikāra_level: madhyama-to-uttama
pedagogical_stage: śravaṇa
cognitive_mode: qualification-framing
```
...
```yaml
cluster: knowledge_means_exclusivity
prakriyā: epistemic-primacy-assertion
ontological_scope: scope-clarification
pedagogical_role: mokṣa-sādhana-niścaya
adhikāra_level: madhyama
pedagogical_stage: śravaṇa
cognitive_mode: causal-clarification
```
...
```yaml
cluster: knowledge_means_exclusivity
prakriyā: karma-knowledge-differentiation
ontological_scope: scope-clarification
pedagogical_role: ignorance-opposition-analysis
adhikāra_level: madhyama
pedagogical_stage: śravaṇa
cognitive_mode: epistemic-discrimination
```
...
prakriyā: obscuration-removal
ontological_scope: dual-register
pedagogical_role: self-revelation-clarification
adhikāra_level: uttama
pedagogical_stage: manana
cognitive_mode: illumination-metaphor
```
...
prakriyā: knowledge-self-cancellation
ontological_scope: pāramārthika
pedagogical_role: assimilation-mechanism
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: purification-analogy
```
...
prakriyā: experiential-illusion-comparison
ontological_scope: dual-register
pedagogical_role: reality-status-reframing
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: dream-analogy
```
...
```yaml
cluster: illusion_superimposition
prakriyā: substratum-discovery
ontological_scope: dual-register
pedagogical_role: adhyāsa-diagnosis
adhikāra_level: madhyama
pedagogical_stage: manana
cognitive_mode: misperception-analysis
```
...
prakriyā: material-cause-illustration
ontological_scope: dual-register
pedagogical_role: multiplicity-within-unity
adhikāra_level: uttama
pedagogical_stage: manana
cognitive_mode: substance-form-analysis
```
...
```yaml
cluster: reflection_identity
prakriyā: substance-form-distinction
ontological_scope: dual-register
pedagogical_role: non-separateness-clarification
adhikāra_level: uttama
pedagogical_stage: manana
cognitive_mode: gold-ornament-analogy
```
...
prakriyā: upādhi-negation
ontological_scope: pāramārthika
pedagogical_role: diversity-appearance-clarification
adhikāra_level: uttama
pedagogical_stage: nididhyāsana
cognitive_mode: space-analogy
```
